    ...
    <div class="nav_top">
    	<div class="nav_top_center">
            ...
            <ul>
                ...
                <li><a href="b/list.jsp">${entry.key.name}</a></li>
	...
	<div class="container5">
    	<div class="cn5_top">
            <div class="cn5_top_x center01">
           		...
           		<c:forEach items="${ map}" var="mmp">
	                <a href="#">${mmp.key.name }</a>
                </c:forEach>
            </div>
            <div class="cn5_top_y center01">
                ...
                <div class="cn5topy_2">
               		 <c:forEach items="${bookList }" var="book2">
	 
		                	<h1 class="pro_title font15">${book2.name } (中文版) 第2版</h1>
		                    <div class="pro_price">
		                            <div class="pro_price_x">
		                                <p> briup价：<b>￥${book2.price }</b> <a href="#">(降价通知)</a></p>
		                            </div>
	                    ...
	                    <div class="pro_ship">
	                        <div>
	                        	<div class="pro_key fl">剩&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;余：98${boo2.remain }</div>
	                        </div>
	                    </div>
	                    <div class="pro_buy">
    	...
    	<div class="c5_b2">
            ...
            <div class="c5_b2_right">
            	<!--选项卡-->
            	<c:forEach items="${ bookList}" var="book3">
	            	<ul class="c5_b2_tabs">
	                	<li>商品介绍</li>
	                ...
	                <!--内容-->
	                  ...
	                  <div class="intro_pics">
	                    	<img class="intro_pic" src="${book3.img }">
	                  </div>
                  </c:forEach>
                </div>
