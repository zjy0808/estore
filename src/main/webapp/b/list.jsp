...
<body>
    ...
    <div class="nav_top">
    	<div class="nav_top_center">
            ...
            <ul>
                ...
                <li><a href="show?cateid=${entry.key.id }">${entry.key.name}</a></li>
    ...
    <div class="container4">
        ...
        <div class="c4_b2">
            <h1 class="c4_b2_x">
            	<c:forEach items="${ map}" var="entry2">
            	
            	<a href="show?cateid=${entry2.key.id }">${ entry2.key.name}&nbsp;&nbsp;&gt;</a>
            	<%-- 
	            	<c:forEach items="${entry2.value }" var="det2">
	                	<span><a href="#">${ det2.name}</a></span>
	            	</c:forEach>
            	...
            	<ul class="c4_b5_c_boxes">
                    ...
                    <!--图片-->
                        ...
                        <div class="c4_b5_c_box_txt">
                        	<h1>￥ ${product.price }</h1>
                            <h2><a href="b/viewBook.jsp?proid=${product.id }">
                        ...
                        <ul class="c4b5_option">
                                ...
                                <a href="buy?bookid=${product.id }">加入购物车 </a></li>
                        </ul>
                    </li>
