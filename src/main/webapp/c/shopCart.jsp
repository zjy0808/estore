...
<!--中间部分div-->
<form action="goconfirm" method="post">
<div class="empty">
	<div class="c_header">
		<div class="leftt">
		...
		<div class="row">
			<div style="float: left" class="line">
				...
				<div style="margin-left: 80px;">
					<img src="images/1.png" width="60" height="70" style="float: left">
			...
			<div style="float: right" class="row_right">
				...
				<div>
					...
					<span><input type="text" class="val" value="2" style="text-align: center"></span>
					<span class="sum">+</span>
				</div>
				<div class="price">￥122元</div> <!-- 小结  总价-->
				<div>
					<a href="">删除</a>
				</div>
			</div>
