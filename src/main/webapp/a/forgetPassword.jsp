...
<body>
	...
	<div class="top">
		<div class="top_center">
			<ul class="top_bars">
				<li><a href="b/index.jsp">退出</a>|</li>
				<li><a href="#">我的订单<span class="jt_down"></span></a>|</li>
				<li><a href="http://www.briup.com">关注杰普<span
	...
	<div class="nav_top">
		<div class="nav_top_center">
			<div>全部图书分类</div>
			<ul>
				<li><a href="b/list.jsp">文学类</a></li>
				<li><a href="b/list.jsp">教育类</a></li>
				<li><a href="b/list.jsp">计算机</a></li>
				<li><a href="b/list.jsp">儿童类</a></li>
				<li><a href="b/list.jsp">漫画类</a></li>
			</ul>
		</div>
	</div>
				...
				<form action="forgetpwd" method="post">
					<ul class="list">
						<li><input id="J_euserName" class="long" name="name"
							value="请输入名字" type="text" onclick="this.value=''" />
						...
						<li><input id="J_euserName" class="long" name="telephone"
							value="15062465004" type="text" onclick="this.value=''" />
						...
						<li><input id="J_euserName" class="long" name="newpwd"
							value="" type="password" />
						...
						<li><input id="J_euserName" class="long" name="confirmpwd"
							value="" type="password" />
						...
						<li>
							<div class="name"></div>
							<h1>${msg1 }</h1>
							<input id="J_eUserNameSubmit"
							type="submit" value="修改" class="btn_red"> <!-- <a id="J_eUserNameSubmit" class="btn_red"  href="javascript:void(0);" onclick="return false">下一步</a> -->
						</li>
					</ul>
				</form>
			</div>
